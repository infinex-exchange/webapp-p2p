    ...
    <body>
        ...
        <div class="col-12 col-lg-9 p-0 ui-card ui-column">
            ...
            <div class="row pb-4 pe-2 pe-lg-0">
                <div class="col-6 col-lg-auto mt-auto pb-2 pb-lg-0 flex-nowrap px-1">
                    <input type="radio" class="btn-check" name="side" id="side-buy" autocomplete="off" checked>
                    <label class="btn small btn-outline-success w-50 m-0 px-4" for="side-buy">Buy</label>

                    <input type="radio" class="btn-check" name="side" id="side-sell" autocomplete="off">
                    <label class="btn small btn-outline-danger w-50 m-0 px-4" for="side-sell">Sell</label>
                </div>
